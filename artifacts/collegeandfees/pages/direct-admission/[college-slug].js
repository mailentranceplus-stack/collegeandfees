...
function WaButton({ href, children, size = "md" }) {
  const cls = size === "sm" ? "btn-whatsapp-sm" : "btn-whatsapp";
  return (
        ...
        <div className="container">
          ...
          {similarColleges.length > 0 && (
            <section style={{ marginTop: "56px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "20px" }}>Other Colleges with Direct Admission in Bangalore</h2>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: "16px" }}>
                {similarColleges.map((c) => (
                  <Link key={c.id} href={`/direct-admission/${c.slug}`} className="mini-card">
                    {c.naac_grade && (
                    ...
                    <p style={{ fontSize: "12px", color: "var(--primary)", fontWeight: 600 }}>View Admission →</p>
                  </Link>
                ))}
              </div>
            </section>
        ...
        <div className="container">
          <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "16px" }}>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <a
                href={waLink(`Hi, I want to know: will I get admission in ${college.name}? What is my chance?`)}
                target="_blank"
      ...
      <main style={{ paddingBottom: "80px" }}>
        <div className="container" style={{ paddingTop: "32px" }}>
          ...
          <nav className="breadcrumb">
            ...
            <Link href="/direct-admission/bangalore">Direct Admission Bangalore</Link>
            <span className="breadcrumb-sep">›</span>
          ...
          <section className="info-box" style={{ marginBottom: "32px" }} id="process">
            ...
            <div style={{ marginTop: "20px", paddingTop: "20px", borderTop: "1px solid var(--border)" }}>
              <WaButton href={waLink(`Hi, what is the exact 2026 direct admission process for ${college.name}?`)} size="sm">
          ...
          <section className="info-box" style={{ marginBottom: "32px" }} id="documents">
            <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "16px" }}>Documents Required for Direct Admission</h2>
          ...
          <section style={{ marginBottom: "32px" }} id="dates">
            <h2 style={{ fontSize: "20px", fontWeight: 700, marginBottom: "16px" }}>
              Important Dates — Direct Admission {college.name} 2026
            </h2>
            <div className="info-box" style={{ padding: 0, overflow: "hidden" }}>
              <table className="fees-table">
                <thead>
          ...
          {faqs.length > 0 && (
            <section style={{ marginBottom: "32px" }} id="faqs">
              ...
              <p style={{ color: "var(--muted-foreground)", marginBottom: "24px", fontSize: "14px" }}>
                Common questions from students and parents about direct admission.
              </p>
              <div>
                {faqs.map((faq) => {
